...
import { Calendar, Database, File, Home, MessageCircle, Search, Settings, Users, ArrowLeft } from 'lucide-react';
...
const AdminSidebar = () => {
  return <Sidebar className="border-r border-hrm-light-gray">
      ...
      <SidebarContent>
        <nav className="space-y-1 py-4">
          ...
          isActive
        }) => cn("flex items-center px-4 py-2 text-sm font-medium rounded-md", isActive ? "bg-hrm-dark-cyan text-white" : "text-gray-600 hover:bg-hrm-light-gray hover:text-hrm-dark-cyan")}>
